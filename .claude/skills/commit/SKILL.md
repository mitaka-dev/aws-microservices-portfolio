...
3. **Generate a commit message** using [Conventional Commits](https://www.conventionalcommits.org/) format:
   ...
   Write a concise subject line (≤72 chars). Add a body only if the change needs context that isn't obvious from the diff. Don't append the Co-Authored-By trailer.
